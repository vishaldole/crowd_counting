...
# image_files = [
#     f for f in os.listdir(os.path.join(train_folder, "images")) if f.endswith(".jpg")
# ]
...
# print(
#     f"Moved {len(val_images)} images and {len(val_gt)} ground-truth files to validation folder."
# )
...
results_folder = "shanghai_a_results"
